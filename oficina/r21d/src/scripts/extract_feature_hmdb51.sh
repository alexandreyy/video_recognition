...
--test_data=/home/oficina/output/hmdb51_feature_extraction/hmdb51_test_01_video_id_dense_l32_$i \
--model_name=r2plus1d --model_depth=34 --clip_length_rgb=32 \
--gpus=0,1,2 \
--batch_size=4 \
--load_model_path=r2plus1d_8.mdl --db_type=minidb \
--output_path=/home/oficina/output/hmdb51_features/ft/hmdb51_test_01_video_id_dense_l32_$i.pkl \
